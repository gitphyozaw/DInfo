...
var snowFall = function() {
    function e() {
        var e = {
            ...
            d = function(t, i, n) {
                ...
                e.image ? (r = new Image, r.src = e.image) : (r = document.createElement("div"), f(r, {
                    ...
                    this.y += this.speed, this.y > o - (this.size + 0) && this.reset(), h(this.element, "translateY(" + this.y + "px) translateX(" + this.x + "px)"), this.step += this.stepSize, this.x += Math.cos(this.step), (this.x + this.size > s - a || this.x < a) && this.reset()
                }, this.reset = function() {
        ...
        return {
            snow: function(r, h) {
                for (l(e, h), n = r, o = n.offsetHeight, s = n.offsetWidth, n.snow = this, "body" === n.tagName.toLowerCase() && (a = 25), window.addEventListener("scroll", function() {
