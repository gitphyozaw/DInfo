    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background: url(assets/img/slide/slider4.jpg);">
          ...
          <!-- Slide 2 -->
          <!-- <div class="carousel-item" style="background: url(assets/img/slide/slider5.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <!-- Slide 3 -->
          <!-- <div class="carousel-item" style="background: url(assets/img/slide/slider6.jpg);">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="box">
              <span>01 Days</span>
              <h4>Lorem Ipsum</h4>
              <p>Ulamco laboris nisi ut aliquip ex ea commodo consequat. Et consectetur ducimus vero placeat</p><br>
            <a href="#book-a-table" class=" btn btn-primary text-center">Package</a>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box">
              ...
              <p>Dolorem est fugiat occaecati voluptate velit esse. Dicta veritatis dolor quod et vel dire leno para dest</p><br>
               <a href="#book-a-table" class=" btn btn-primary text-center">Package</a>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box">
              ...
              <p>Molestiae officiis omnis illo asperiores. Aut doloribus vitae sunt debitis quo vel nam quis</p><br>
               <a href="#book-a-table" class=" btn btn-primary text-center">Package</a> 
            </div>
          </div>
