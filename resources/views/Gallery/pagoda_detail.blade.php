...
<link href="{{ asset('css/gallery.css') }}" rel="stylesheet">
    ...
    <div class="row">
        ...
        <div class="detail">
            ...
            <a href="{{url('/gallery_pagoda_detail')}}">
                <img class="d-flex align-self-start" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSN2KWhdM_Yzi0wrRjebIwP-Cr1q3dxkPbDTxwz80iowevCrvQb&usqp=CAU" alt="Generic placeholder image">
            </a>
              <div class="about">
