    ...
    <div class="row shadow-lg p-3 mb-5 bg-white rounded">
        ...
        <div class="media">
            ...
            <a href="{{url('/menu_hotel_detail')}}">
                <img class="d-flex align-self-start" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRKQz-lu4yIeF2PSIkE8z4LqcZyAmO8UySRiKfPiVLf8WItlWrN&usqp=CAU" alt="Generic placeholder image">
            </a>
              <div class="media-body pl-3">
                <div class="price"> Hotel name</div>
                <div class="stats">
