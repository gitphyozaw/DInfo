...
<link href="{{ asset('css/gallery.css') }}" rel="stylesheet">
    ...
    <div class="row">
        ...
        <div class="media">
            ...
            <a href="{{url('/menu_restaurant_detail')}}">
                <img class="d-flex align-self-start" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTqC1ZDuxbp_ngctVXUDRIYGNpKhrgrU-iXs_x_hPdf1ma1PzB0&usqp=CAU" alt="Generic placeholder image">
            </a>
