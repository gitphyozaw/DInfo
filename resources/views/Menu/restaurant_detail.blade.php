        ...
        <div class="col-md-6 listing-block">
            <div class="detail">
                ...
                <a href="{{url('/menu_restaurant_detail')}}">
                    <img class="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTb6e8tysph1SnLGl0mcUAj7kzFboIJwgVT_pf5Cs1omohmZyGR&usqp=CAU" alt="Generic placeholder image">
                </a>
                  <div class="about">
                   Restaurant Name<br>
