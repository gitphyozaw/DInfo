        ...
        <div class="col-md-6 listing-block">
            <div class="detail">
                ...
                <a href="{{url('/menu_mountain_detail')}}">
                    <img class="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT727uICyQYcs7TTSVK4l6T-9gZW2jfx4lbEMEJm3pQGwVJryBX&usqp=CAU" alt="Generic placeholder image">
                </a>
                  <div class="about">
                    Mountain Name<br>
